...
class Storage extends Component <AllProps, State> {
    ...
    updateIngredients = (e: any, ingredientTitle: string): void => {
        ...
        switch (e.target.value) {
            case '+': {
                ...
                if(newBudget < 0){
                    this.setState({showAlert: true, typeAlert: 'danger', msgAlert:'You have exceeded your budget'})
                setTimeout(()=>{
            ...
            case '-': {
                if(newRefill[ingredientTitle] <= this.props.getAllIngredients[ingredientTitle]){
                    return;
                }
                newRefill[ingredientTitle]--;
                newBudget += initialIngredientsPrice[ingredientTitle]
    ...
    updateStore = () => {
        this.setState({showAlert: true, typeAlert: 'success', msgAlert:'The order was successful'})
        setTimeout(()=>{
            this.setState({showAlert: false, msgAlert: ''})
        }, 4000)
